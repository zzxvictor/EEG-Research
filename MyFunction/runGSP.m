function [g, graphCluster,sampledEEG, physDist, sigDist, sigGauss,phyGauss,multi,b,u,a,dist] = runGSP(sensorNum, dimension,sigma1, sigma2, edgeNum, clusterNum, filterN)
...
% parameter recommendation: sigma1 0.4 sigma2 0.6, edgeNum 10
    ...
    [a,b,dist] = kmeans(u(:,1:clusterNum),clusterNum,'MaxIter',1000);
    
        %padding zeros at the end of b
        b = [b;zeros(sensorNum - clusterNum, clusterNum)];
        %retrieve four graph clusters
        graphCluster = g.Finv*b;
        %normalization
